...
document.querySelector(
  "body"
).style.backgroundImage = `url(${chrome.runtime.getURL("/clouds.gif")})`;
...
let h = document.documentElement.scrollHeight - 100;
let w = document.documentElement.scrollWidth - 100;
